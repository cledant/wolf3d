...
/*   Updated: 2016/02/14 17:49:42 by cledant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "wolf3d.h"

static int		ft_load_texture_4(t_mlx *e)
{
	int		width;
	int		length;
...
static int		ft_load_texture_3(t_mlx *e)
{
	int		width;
	int		length;
	...
	if ((e->img_c4 = mlx_xpm_file_to_image(e->mlx,
		...
		return (0);
	if (ft_load_texture_4(e) == 0)
		return (0);
	else
		return (1);
}

static int		ft_load_texture_2(t_mlx *e)
{
	int		width;
	int		length;
